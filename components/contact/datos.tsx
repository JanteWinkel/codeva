...
const Datos = () => {
    return (
        <div className="mt-4 grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 lg:gap-8 mx-4">
            {/* Icon Block 1 */}
            <a
                className="group flex flex-col h-full text-center rounded-lg hover:bg-gray-300 focus:outline-none focus:bg-gray-100 p-4 sm:p-6 dark:hover:bg-neutral-500/10 dark:focus:bg-neutral-500/10 mx-auto"
            ...
            {/* Icon Block 2 */}
            <a
                className="group flex flex-col h-full text-center rounded-lg hover:bg-gray-300 focus:outline-none focus:bg-gray-100 p-4 sm:p-6 dark:hover:bg-neutral-500/10 dark:focus:bg-neutral-500/10"
